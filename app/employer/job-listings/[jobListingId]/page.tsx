...
} from "@/features/jobListings/lib/planFeatureHelper";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
const StatusUpdateButton = ({
  ...
  const button = (
    <ActionButton
      ...
      variant="outline"
      requiredAreYouSure={getNextJobListingStatus(status) === "published"}
...
const statusToggleButtonText = (status: JobListingStatusEnum) => {
  switch (status) {
    case "delisted":
    case "draft":
      return (
