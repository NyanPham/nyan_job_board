...
const JobListingFilterForm = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      locationRequirement:
        (searchParams.get("locationRequirement") as LocationRequirementEnum) ??
        ANY_VALUE,
      stateAbbreviation: searchParams.get("stateAbbreviation") ?? ANY_VALUE,
      experienceLevel:
        (searchParams.get("experienceLevel") as ExperienceLevelEnum) ??
        ANY_VALUE,
      type: (searchParams.get("type") as JobListingTypeEnum) ?? ANY_VALUE,
    },
  });
